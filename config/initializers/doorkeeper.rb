...
DoorkeeperConfig = {
      ...
      author_url: "",
      version: "0.0.1",
      my_oauth_applications_url: "http://owen.com:3000/oauth/applications" # url of the doorkeeper site where to create applications
    }

DoorkeeperConfig = {
      site: 'http://my.hsfdev.com'.freeze, # url of the doorkeeper site
      authorize_url: 'http://my.hsfdev.com/oauth/authorize', # url of the doorkeeper site to authorize login
      token_url: 'http://my.hsfdev.com/oauth/token', # # url of the doorkeeper for token
      profile_url: "http://my.hsfdev.com/users/{user_id}/profile/", # url of the doorkeeper site where to see the user profile
      domain: "my.hsfdev.com", # domain of the doorkeeper site
      canvas_token: 'DkzYDsU3Oxxhcd7vYUOG03mRKXadnOYYdbQEKvHAzKT9bjsaV59PjtWNePEXmj6l', # developer token generated in canvas lms
      default_pass: "^&*^&*^&*^&*^&*^*^&*^&*^&*^&*^$%^#@^%&*", # default pass for new users created by doorkeeper
      user_id_owner_accounts: 1, # profile id who will be the owner of new users created by doorkeeper
      logout_url: "http://my.hsfdev.com/en/users/sign_out?redirect_url={canvas_login_url}", # url redirected after logout
      author: "hsf",
      author_url: "",
      version: "0.0.1",
      my_oauth_applications_url: "http://my.hsfdev.com/oauth/applications" # url of the doorkeeper site where to create applications
    }
